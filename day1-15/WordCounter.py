...
target_word_count = 5  # Replace with your desired target word count
...
def session_info():
    ...
    if word_count > target_word_count:
        ...
        message = f"Congrats! You have achieved your {target_word_count} Words Target"
